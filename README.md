...
*  *Serial methods*
    * [for parallelism in time](/Serial methods/serial_method_for_parallelism_across_the_system.clj)
    * [for parallelism across the system](/Serial methods/serial_method_for_parallelism_in time.clj)
* *Test systems*
